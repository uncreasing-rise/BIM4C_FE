...
export const uiEn = {
  bimCanvas: {
    ...
    t3DRenderingIsUnavailableRetry: "3D rendering is unavailable. Retry or check your browser's WebGL support.",
    retry: "Retry"
  },
  bimControlsOverlay: {
    ...
    dragTheRoundHandlesOn: "Drag the round handles on the box faces to cut directly in the view (red = X, green = Y, blue = Z), or use the sliders.",
    ...
    midpoint: "Midpoint",
    edge: "Edge",
    hoverToPreviewTheSnapped: "Hover to preview the snapped point, click point 1 then point 2. Esc cancels the pending point.",
    clickTheModelToRead: "Click the model to read the point's IFC coordinates (and E/N/H when the file is georeferenced).",
    point1SetSelectPoint: "Point 1 set — select point 2.",
    deleteMeasurement: "Delete measurement",
    plan: "Plan",
    snap: "Snap",
    collapseModel: "Collapse model",
    noClashResultsAreAvailable: "No clash results are available for this model. Load an IFC with coordination issues to review them."
  },
  bimModelsPanel: {
    loadedModels: "Loaded models",
    close: "Close",
    filesThatShareACoordinate: "Files that share a coordinate system are placed at their true positions. The first model anchors the view; displayed coordinates are always the original IFC coordinates.",
    base: "Base",
    elements: "elements",
    hide: "Hide",
    show: "Show",
    ...
    thisModelIsMoreThan: "This model is more than 5 km from the base model. The files may not share a coordinate system — choose “By origin” and align manually.",
    alignment: "Alignment",
    sharedCoordinates: "Shared coordinates",
    byOrigin: "By origin",
    extraMoveAlongIFCAxes: "Extra move along IFC axes (m) and rotation about the vertical axis through the file origin (degrees).",
    rot: "Rot°",
  ...
  bimPropertyInspector: {
    ...
    material: "Material",
    illustrativePropertiesNotExtractedFrom: "Illustrative properties, not extracted from IFC.",
    coordinatesIFCM: "Coordinates (IFC, m)",
    model: "Model",
    bottomElevation: "Bottom elevation",
    topElevation: "Top elevation",
    centreAndElevationsComeFrom: "Centre and elevations come from the element's bounding box.",
    axisAlignedBoundingDimensionsEstimate: "Axis-aligned bounding dimensions (estimate)",
    ...
    area: "Area",
    volume: "Volume",
    boundingDimensionsAreNotQuantities: "Bounding dimensions are not quantities. Source quantities, when available, are listed below with their units.",
  ...
  bimViewerPage: {
    onlyIfcFilesAreAccepted: "Only .ifc files are accepted — others were skipped.",
  ...
  blogDetailView: {
    ...
    technicalInsightsAndCaseAnalysis: "Technical insights and case analysis authored by BIM4C specialists to advance digital construction practices.",
  ...
  courseDetailView: {
    ...
    handsOnProjectsWithBilingual: "Hands-on projects with bilingual technical standards.",
    instructorMentorship: "Instructor Mentorship:",
    seasonedBIMManagersLeadingReal: "Seasoned BIM Managers leading real mega projects.",
    bIM4CCertificate: "BIM4C Certificate:",
    verifiedCredentialWithQRAuthentication: "Verified credential with QR authentication.",
    postCourseSupport: "Post-course Support:",
    communitySupportAndIndustryJob: "Community support and industry job connections.",
  ...
  projectDetailView: {
    requestTailoredConsultationAndDelivery: "Request tailored consultation and delivery proposal for your project from BIM4C engineers.",
  ...
  aboutView: {
    ...
    standardizedCDEDataEnvironmentAnd: "Standardized CDE data environment and accurate information models for modern construction",
    downloadBrochurePDF: "Download Brochure (PDF)"
  },
  bimHero3DCanvas: {
    fullBIMViewer: "Full BIM Viewer",
    multidisciplinary3DModelAutoOrbit: "Multidisciplinary 3D Model (Auto-Orbit)"
  },
  consultationSection: {
  ...
  deliveryProcess: {
    ...
    agreeScopeEIRInformationRequirements: "Agree scope, EIR information requirements, LOD matrix and CDE responsibilities.",
    bIMExecutionPlan: "BIM Execution Plan",
    modelingIntegration: "Modeling & Integration",
    bringArchitectureStructureMEPModels: "Bring Architecture, Structure, MEP models and specs into a unified federated CDE workflow.",
    federatedModel: "Federated Model",
    clashResolution: "Clash Resolution",
    automatedClashDetectionIssueMatrix: "Automated clash detection, issue matrix tracking and multi-discipline coordination sign-off.",
    modelCoordinationReport: "Model coordination report",
    digitalHandover: "Digital Handover",
    verifyOutputsExtractAccurateQTO: "Verify outputs, extract accurate QTO quantities and assemble COBie data for Digital Twin/FM.",
  ...
  homeView: {
    ...
    bIMConsultingMultidisciplinaryModelCoordination: "BIM consulting, multidisciplinary model coordination and CDE information governance — from concept through operations.",
    exploreBIMIn3D: "Explore BIM in 3D",
    contentIsBeingUpdatedPlease: "Content is being updated. Please contact BIM4C.",
    ourExpertise: "Our expertise",
    defineYourBIMStrategyConnect: "Define your BIM strategy, connect your disciplines and equip your team with information they can use.",
    selectedExperience: "Selected experience",
    realProjectsConnectedExpertise: "Real projects. Connected expertise.",
    allProjects: "All projects",
    bIMTrainingAndTechnologyTransfer: "BIM training and technology transfer for businesses and students.",
    buildYourTeamSNext: "Build your team’s next BIM capability.",
    practicalProgrammesForModelersCoordinators: "Practical programmes for Modelers, Coordinators and BIM Managers with guided hands-on exercises.",
    ...
    shareTheContextGoalOr: "Share the context, goal or issue you are working through. We will help define the right scope together.",
  ...
  officeLocationMap: {
    headquartersAddressCopiedToClipboard: "Headquarters address copied to clipboard",
    bIM4CDaNangHeadquartersMap: "BIM4C Da Nang Headquarters Map",
    corporateHeadquarters: "Corporate Headquarters",
    bIM4CTECHNOLOGYCONSTRUCTIONJOINTSTOCK: "BIM4C TECHNOLOGY & CONSTRUCTION JOINT STOCK COMPANY",
    openMaps: "Open Maps",
    socialMediaNetworks: "Social Media & Networks",
    connectWithBIM4CAcrossPlatforms: "Connect with BIM4C across platforms",
    followUsToStayUpdated: "Follow us to stay updated with professional insights, BIM tutorials, and industry events."
  },
  serviceDetailView: {
    enquireForThisService: "Enquire for this service",
    serviceDeliveryFramework: "Service Delivery Framework",
    informationManagementAndCDECoordination: "Information management and CDE coordination.",
    openBIMIFCBCFComplianceEnsuring: "OpenBIM (IFC, BCF) compliance ensuring frictionless cross-platform interoperability.",
    fullLegalNDAComplianceSafeguarding: "Full legal NDA compliance safeguarding intellectual property and proprietary data.",
    receiveExpertConsultationDetailedScope: "Receive expert consultation, detailed scope of work and quotation tailored to your needs.",
  ...
  commandMenu: {
    ...
    exploreHighRiseAndInfrastructure: "Explore high-rise and infrastructure portfolio",
    ...
    practicalRevitNavisworksOpenBIMCurriculum: "Practical Revit, Navisworks & OpenBIM curriculum",
    insightsTechnicalJournal: "Insights & Technical Journal",
    fieldTestedAECDigitalMethods: "Field-tested AEC digital methods and lessons",
    aboutBIM4CLeadershipCapability: "About BIM4C (Leadership & Capability)",
    executiveTeamEngineeringCapability: "Executive team & engineering capability",
    ...
    searchProjectsServicesCoursesArticles: "Search projects, services, courses, articles, tax ID...",
  ...
  notFoundView: {
    ...
    theLinkYouAccessedIs: "The link you accessed is no longer available. Please return to the homepage or explore our enterprise BIM technology solutions.",
  ...
  errorState: {
    ...
    aConnectionIssueOccurredOr: "A connection issue occurred or this content is temporarily unavailable. Please try again.",
    tryAgain: "Try again"
  },
  /** Strings with parameters or structure (functions keep word order per language). */
  formats: {
    snap: { vertex: "Vertex", midpoint: "Midpoint", edge: "Edge", face: "Face" },
    ...
    modelsInScene: (count: number) => `${count} model${count === 1 ? "" : "s"} in scene`,
    federatedModels: (count: number) => `${count} federated models`,
    modelAdded: (file: string, elements: number) => `Added ${file}: ${elements} elements.`,
    ifcErrors: {
      IFC_FILE_EMPTY: "The IFC file is empty.",
      IFC_NO_GEOMETRY: "This file contains no supported 3D geometry. No substitute shapes were created.",
      IFC_WORKER_FAILED: "The IFC reader could not start. Reload the page and retry.",
    ...
    expertiseTitle: ["The right support.", "At every project stage."] as [string, string],
  }
};
