...
export const enDictionary: Dictionary = {
  common: {
    talkToExpert: "Speak to a Specialist",
    contact: "Contact Us",
    ourWork: "Our Projects",
    exploreExpertise: "Explore Capabilities",
  ...
  navigation: {
    ...
    courses: "Academy",
    blog: "Insights",
    technical: "BIM Expertise",
    news: "News",
    bimViewer: "Explore 3D BIM",
    contact: "Contact",
    legal: "Legal",
    terms: "Terms",
    privacy: "Privacy",
    exploreBim4c: "Explore BIM4C",
    tagline: "Digital Construction Transformation",
    requestConsultation: "Request Consultation",
  },
  hero: {
    badge: "DIGITAL CONSTRUCTION DATA ECOSYSTEM · OPENBIM & CDE",
    titleMain: "BIM Data Infrastructure.",
    titleHighlight: "Accurate. Actionable. Digitally Delivered.",
    description:
      "BIM consultancy and implementation, integrating digital workflows into design, construction, and asset management.",
    ctaPrimary: "Request Solution Consultation",
    ctaSecondary: "Explore Flagship Projects",
    featureBimStrategy: "ISO 19650 / BEP Standards",
    featureCoordination: "Multidisciplinary Clash Control on CDE",
    ...
    bimViewport: {
      ...
      liveModelStatus: "BIM Model Visualization",
      layers: {
        arch: "Architecture (ARC)",
        struct: "Structure (STR)",
        mep: "MEP Engineering",
        timeline: "4D Timeline",
      },
    },
  },
  expertiseStrip: {
    bimConsulting: {
      ...
      desc: "Standards, implementation plans and project lifecycle management",
    },
    training: {
      title: "Training",
    ...
    design: {
      title: "Design",
      desc: "Multidisciplinary coordination and constructability review",
    },
    supervision: {
      title: "Supervision",
      desc: "Digital inspection, site safety and quality control",
    },
  },
  deliveryProcess: {
    eyebrow: "How We Work",
    ...
    description:
      "Every engagement follows a structured methodology to ensure data consistency, eliminate site rework and maximize capital efficiency.",
    step1: {
      title: "1. Assess & Define",
      desc: "Establish project goals, assess BIM maturity, and define tailored delivery plans (BEP/EIR).",
    },
    step2: {
      title: "2. Model & Integrate",
      desc: "Develop multidisciplinary models strictly adhering to project LOD standards and naming conventions.",
    },
    step3: {
      title: "3. Coordinate & Review",
      desc: "Detect clashes early, facilitate cross-discipline review sessions, and track issue resolution to closeout.",
    },
    step4: {
      title: "4. Handover & Operations",
      desc: "Deliver validated as-built models and structured asset data ready for downstream operations.",
    },
  },
  partners: {
    eyebrow: "Trusted by Leading Industry Enterprises",
    title: "Clients & Partners",
    description:
      "We collaborate with leading owners, main contractors, and engineering consultancies across Vietnam.",
  },
  consultation: {
    eyebrow: "Get in touch",
    title: "Ready to start your BIM journey?",
    description:
      "Speak directly with our BIM specialists to assess your project requirements and receive a practical delivery proposal.",
    nameLabel: "Full name",
  ...
  footer: {
    ...
    newsletterTitle: "Receive BIM Insights",
    newsletterDesc:
      "Project news and digital construction insights delivered directly to your inbox.",
  ...
  projectsPage: {
    ...
    showingText: (shown: number, total: number) => `Showing ${shown} of ${total} projects`,
    matchingCount: (count: number) => `${count} matching projects`,
  ...
  servicesPage: {
    eyebrow: "BIM4C Capabilities",
    title: "Solutions for the whole project lifecycle",
    description:
      "From strategy and design coordination to digital handover, each solution is built around a measurable outcome.",
    catalogueEyebrow: "Solution catalogue",
    catalogueTitle: "Expertise matched to your project.",
    catalogueDesc:
      "From BIM strategy to coordinated models and asset data, find the right support for your stage and team.",
    searchLabel: "Search solutions",
    searchPlaceholder: "Search by name, objective or capability...",
    matchingCount: (count: number) => `${count} matching solutions`,
    solutionBadge: "BIM4C Solution",
    exploreSolution: "Explore solution",
    emptyTitle: "No solutions found",
    emptyDesc: "Try another search term or category.",
  ...
  blogPage: {
    ...
    matchingCount: (count: number) => `${count} matching articles`,
    readMore: "Read more →",
    emptyTitle: "No articles found",
    emptyDesc: "Try another keyword or topic.",
  },
  contactPage: {
    eyebrow: "Contact",
    heroTitle: "Let's talk about your project.",
    heroDesc:
      "Tell us where you are in the project lifecycle. Together, we will define the right BIM support and next steps.",
  ...
  detailPage: {
    ...
    viewAll: "View all",
    byAuthor: "By",
    getInsightsTitle: "Receive BIM Insights",
    getInsightsDesc:
      "Practical project lessons and digital construction insights delivered directly to your inbox.",
    certificateTitle: "BIM4C Verified Certificate",
    certificateDesc:
      "Issued with a QR verification code and digital competency profile upon graduation project completion.",
    certificateBadge: "VERIFIED COMPETENCY",
    projectProfile: "Project Profile",
    courseProfile: "Course Overview",
    serviceProfile: "Solution Overview",
    articleInfo: "Article Details",
    ...
    deliverables: [
      ...
      "BCF Clash Matrix & Multidisciplinary Issue Tracking Report",
      "Automated Shop Drawings & As-Built COBie Asset Data",
    ],
    authorProfileTitle: "Author / Research Division",
    authorRole: "BIM & Digital Technology Research (BIM4C R&D Lab)",
    fields: {
      client: "Client / Owner",
      location: "Location",
      scale: "Scale",
  ...
  forms: {
    ...
    messagePlaceholder:
      "What project are you working on, and where would you like our help?",
    consentLabel: "I have read and agree to the",
    privacyPolicy: "Privacy Policy",
    consentSuffix: "and the processing of my personal data.",
    submitEnquiry: "Submit project enquiry",
    submitRegistration: "Enquire about this programme",
    submitting: "Submitting...",
    registrationNotice:
      "We will contact you regarding class schedules, tuition and next steps. Submitting this form does not reserve a place.",
    thankYouTitle: "Thank you for getting in touch.",
    thankYouDesc:
      "Our team will review your request and get back to you using the details you provided.",
    sendAnother: "Send another enquiry",
    dataProtectionNote:
      "BIM4C uses this information only to respond to your enquiry.",
  },
  legalPage: {
    eyebrow: "LEGAL INFORMATION",
    heroTitle: "Transparency in every commitment",
    heroDesc:
      "Policies and terms that apply when you access, interact and share information with BIM4C.",
    sectionEyebrow: "BIM4C LEGAL",
    sectionTitle: "What you should know",
    sectionDesc:
      "Select a document below to understand how we operate this website and protect your rights as a user.",
    readDocument: "Read document",
  },
  bimViewerPage: {
    badge: "IFC Viewer · Three.js & Web-IFC",
    title: "Interactive Online 3D BIM Viewer",
    subtitle:
    ...
    sections: {
      title: "Axis Section Planes",
      axisX: "Section along X-axis",
      axisY: "Section along Y-axis",
      axisZ: "Section along Z-axis",
      resetClipping: "Reset Sections",
    },
    measure: {
      title: "3D Distance Measurement",
      instruction:
        "Click 2 points on the 3D model surface to measure real-world distance.",
      distance: "Euclidean Distance (L)",
    ...
    explode: {
      title: "Model Explode View",
      intensity: "Explode Intensity",
    },
    properties: {
      title: "IFC Property Inspector",
      noSelection: "No Object Selected",
      noSelectionDesc:
        "Click on any 3D element to inspect its IFC attributes and technical property sets.",
      elementName: "Element Name",
      ifcType: "IFC Type",
      guid: "Global Identifier (GUID)",
      storey: "Storey / Level",
      psetsTitle: "Property Sets (Psets)",
      geometryTitle: "Geometry & Native Properties",
      spatialTree: "Spatial Hierarchy Tree",
    },
    clashes: {
      title: "Example Coordination Issues",
      count: (count: number) => `${count} coordination issues`,
      severity: {
        high: "Critical (High)",
        medium: "Medium",
        low: "Advisory (Low)",
      },
      focusClash: "Zoom to Clash",
    },
    performance: {
      fps: "FPS",
      elements: "Elements",
      memory: "Geometry Buffer",
