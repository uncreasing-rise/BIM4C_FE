...
export const uiVi: UiStrings = {
  ...
  bimControlsOverlay: {
    ...
    dragTheRoundHandlesOn:
      "Kéo các nút tròn trên mặt hộp để cắt trực tiếp trong khung nhìn (đỏ = X, xanh lá = Y, xanh dương = Z), hoặc chỉnh bằng thanh trượt.",
    ...
    threePointHelp: "Chọn A, B, C. Góc đo tại B; diện tích là tam giác 3D, không phải đa giác hoặc diện tích bề mặt.",
    snapping: "Bắt điểm",
    vertex: "Đỉnh",
    midpoint: "Trung điểm",
    edge: "Cạnh",
    hoverToPreviewTheSnapped:
      "Rê chuột để thấy điểm được bắt, nhấp điểm 1 rồi điểm 2. Esc để hủy điểm đang chọn.",
    clickTheModelToRead:
      "Nhấp lên mô hình để lấy tọa độ IFC của điểm (và E/N/H nếu tệp có georeference).",
    ...
    clashesLoaded: (count: number) => `Đã nạp ${count} clash từ mô hình IFC.`,
  },
  bimModelsPanel: {
    loadedModels: "Mô hình đã tải",
    close: "Đóng",
    filesThatShareACoordinate:
      "Các tệp dùng chung hệ tọa độ được ghép đúng vị trí thực. Mô hình đầu tiên làm gốc hiển thị; tọa độ đọc ra luôn là tọa độ IFC gốc.",
    base: "Gốc",
    elements: "cấu kiện",
    hide: "Ẩn",
    show: "Hiện",
    ...
    thisModelIsMoreThan:
      "Mô hình này cách mô hình gốc hơn 5 km. Có thể hai tệp không cùng hệ tọa độ — hãy chọn “Theo gốc tọa độ” và căn chỉnh thủ công.",
    alignment: "Căn chỉnh vị trí",
    sharedCoordinates: "Tọa độ dùng chung",
    byOrigin: "Theo gốc tọa độ",
    extraMoveAlongIFCAxes:
      "Dời thêm theo trục IFC (m) và xoay quanh trục đứng qua gốc tệp (độ).",
    rot: "Xoay°",
  ...
  bimPropertyInspector: {
    ...
    hideElement: "Ẩn cấu kiện",
    isolateElement: "Cô lập cấu kiện",
    showAllElements: "Hiện tất cả cấu kiện",
    fitSelection: "Vừa khung vùng chọn",
  },
  bimToolbar: {
  ...
  commandMenu: {
    ...
    inspectIFCBCFSpatialCoordination:
