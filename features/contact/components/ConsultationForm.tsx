...
export function ConsultationForm({
  ...
  const captionClass =
    "text-micro font-semibold uppercase tracking-[.06em] text-white/70";
  const inputClass =
    "h-12 w-full border border-white/25 bg-white/[.07] px-[13px] text-[16px] text-white outline-none transition focus:border-[#ffffff] focus:bg-white/10";
  return (
    <form className="grid grid-cols-1 gap-[18px]" onSubmit={submit} noValidate>
      ...
      <label className={labelClass}>
        ...
        <textarea
          className="w-full resize-y border border-white/25 bg-white/[.07] p-[13px] text-white outline-none transition placeholder:text-white/45 focus:border-[#ffffff] focus:bg-white/10"
          name="message"
          rows={compact ? 3 : 4}
          required
      ...
      <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
        ...
        <small className="text-micro text-white/55">
