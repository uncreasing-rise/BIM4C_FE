...
export type AdminContentStatus = "DRAFT" | "PUBLISHED" | "ARCHIVED" | "PLANNED" | "IN_PROGRESS" | "COMPLETED";
export interface AdminContentBlock { title: string; body: string }
export interface AdminCategory { id: string; slug: string; name: string }
