...
export function generateDemoIfc({ millimetres = false } = {}) {
  ...
  const shape = (w, d, h, kind) => {
    ...
    const rgb = kind === "IFCDUCTFITTING" ? "0.08,0.55,0.62" : kind === "IFCSLAB" ? "0.38,0.48,0.58" : kind === "IFCWALL" ? "0.72,0.72,0.68" : "0.5,0.57,0.65";
...
if (process.argv[1] === fileURLToPath(import.meta.url))
  writeFileSync(
    new URL("../public/models/bim4c-commercial-tower.ifc", import.meta.url),
    generateDemoIfc(),
  );
