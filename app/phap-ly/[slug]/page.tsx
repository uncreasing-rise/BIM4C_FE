...
export default async function LegalDetailPage({params}:{params:Promise<{slug:string}>}) {
  ...
  return <div className="public-legal-detail">
    <PageHero eyebrow="PHÁP LÝ BIM4C" title={document.title} description={document.summary} image="/images/news-project-coordination.webp"/>
    ...
    </div><div className="mx-auto mt-12 w-[calc(100%_-_32px)] max-w-[1220px] border-t border-[#dbe7e5] pt-6 md:w-[calc(100%_-_48px)]"><Link className="text-xs font-semibold uppercase text-[#09a7a5]" href={ROUTES.legal}>← Tất cả thông tin pháp lý</Link></div></article>
  </div>;
}
