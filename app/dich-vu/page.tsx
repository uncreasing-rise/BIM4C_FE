  ...
  return <main>
    ...
    <section className="relative overflow-hidden bg-white py-16 lg:py-20">
      ...
      <div className="relative mx-auto grid w-[calc(100%_-_32px)] max-w-[1400px] gap-9 md:w-[calc(100%_-_64px)] lg:grid-cols-[.85fr_1.15fr] lg:items-start lg:gap-24">
        <div><p className="mb-4 text-xs font-semibold text-[#087f7d]">Năng lực BIM4C</p><h1 className="text-4xl font-semibold leading-[1.1] text-[#09a7a5]">Một đối tác xuyên suốt vòng đời dự án.</h1></div>
    ...
    <section className="bg-[#f5fafa] py-16 lg:py-20" aria-label="Các dịch vụ của BIM4C">
        ...
        <div className="border-t border-[#09a7a5]">
          {services.map((service, index) => <article className="group relative grid scroll-mt-24 border-b border-[#dbe7e5] py-8 lg:grid-cols-[minmax(360px,.82fr)_minmax(0,1.18fr)] lg:py-12" id={service.slug} key={service.slug}>
            ...
            <div className={`flex flex-col justify-center bg-white p-6 md:p-10 lg:p-14 ${index % 2 ? "lg:order-1 lg:mr-[-1px]" : "lg:ml-[-1px]"}`}>
              <p className="mb-4 text-xs font-semibold text-[#087f7d]">{service.eyebrow}</p>
              ...
              <Link className="relative z-20 mt-7 w-fit border-b border-[#09a7a5] pb-1 font-semibold text-[#087f7d]" href={ROUTES.serviceDetail(service.slug)}>Khám phá dịch vụ →</Link>
            </div>
          </article>)}
        </div>
      </div>
