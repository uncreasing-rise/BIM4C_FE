...
export default async function ProjectsPage(){const projects=await getProjects();return <main className="public-index public-projects"><PageHero eyebrow="BIM4C" title="Dự án" description="Những công trình khẳng định năng lực triển khai và cam kết của BIM4C." image="/images/project-lumi.jpg"/><ProjectExplorer projects={projects}/></main>}
