...
export const SOCIAL_NETWORKS: SocialItem[] = [
  ...
  },
  {
    id: "zalo",
    name: "Zalo OA",
    url: "https://zalo.me/02873004068",
    handle: "BIM4C Official",
    icon: ZaloIcon,
    color: "text-[#0068FF]",
  ...
  },
  {
    id: "github",
    name: "GitHub OpenBIM",
    url: "https://github.com/bim4c",
    handle: "github.com/bim4c",
    icon: GithubIcon,
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 ${className}`}>
        {SOCIAL_NETWORKS.map((item) => {
          ...
          return (
            ...
            >
              <div className={`rounded-xl border border-border bg-background p-2.5 shadow-2xs group-hover:scale-110 transition-transform ${item.color}`}>
