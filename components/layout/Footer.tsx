    ...
    <footer className="site-footer" id="contact">
      <div className="site-footer-inner">
        ...
        <div className="footer-brand">
          ...
          <p>
            Cách mạng hóa ngành xây dựng với giải pháp BIM sáng tạo, bền vững và
            hiệu quả.
          </p>
      ...
      <div className="site-footer-bottom">
        ...
        <div>
          <Link href={ROUTES.legalDetail("dieu-khoan-su-dung")}>
            Điều khoản sử dụng
          </Link>
          <Link href={ROUTES.legalDetail("chinh-sach-bao-mat")}>
            Chính sách bảo mật
          </Link>
        </div>
      </div>
